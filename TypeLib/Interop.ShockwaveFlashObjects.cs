...
//[assembly: AssemblyTitle("ShockwaveFlashObjects")]
...
// Type library source file name: C:\WINDOWS\system32\Macromed\Flash\FlDbg10e.ocx
...
namespace ShockwaveFlashObjects
{
  ...
  public interface IDispatchEx
  {
    ...
    /// <remarks><para>An original IDL definition of <c>RemoteInvokeEx</c> method was the following:  <c>HRESULT RemoteInvokeEx (long id, unsigned long lcid, unsigned long dwFlags, [in] stdole.DISPPARAMS* pdp, [out] VARIANT* pvarRes, [out] stdole.EXCEPINFO* pei, IServiceProvider* pspCaller, unsigned int cvarRefArg, [in] unsigned int* rgiRefArg, [in, out] VARIANT* rgvarRefArg)</c>;</para></remarks>
    // IDL: HRESULT RemoteInvokeEx (long id, unsigned long lcid, unsigned long dwFlags, [in] stdole.DISPPARAMS* pdp, [out] VARIANT* pvarRes, [out] stdole.EXCEPINFO* pei, IServiceProvider* pspCaller, unsigned int cvarRefArg, [in] unsigned int* rgiRefArg, [in, out] VARIANT* rgvarRefArg);
    // VB6: Sub RemoteInvokeEx (ByVal id As Long, ByVal lcid As Long, ByVal dwFlags As Long, pdp As stdole.DISPPARAMS, pvarRes As Any, pei As stdole.EXCEPINFO, ByVal pspCaller As IServiceProvider, ByVal cvarRefArg As Long, rgiRefArg As Long, rgvarRefArg As Any)
    [DispId(1610743809)]
    void RemoteInvokeEx (int id, uint lcid, uint dwFlags, [In] ref stdole.DISPPARAMS pdp, [Out] out object pvarRes, [Out] out stdole.EXCEPINFO pei, IServiceProvider pspCaller, uint cvarRefArg, [In] ref uint rgiRefArg, [In, Out] ref object rgvarRefArg);
  ...
  public interface IServiceProvider
  {
    ...
    /// <remarks><para>An original IDL definition of <c>RemoteQueryService</c> method was the following:  <c>HRESULT RemoteQueryService ([in] stdole.GUID* guidService, [in] stdole.GUID* riid, [out] IUnknown** ppvObject)</c>;</para></remarks>
    // IDL: HRESULT RemoteQueryService ([in] stdole.GUID* guidService, [in] stdole.GUID* riid, [out] IUnknown** ppvObject);
    // VB6: Sub RemoteQueryService (guidService As stdole.GUID, riid As stdole.GUID, ppvObject As IUnknown)
    void RemoteQueryService ([In] ref stdole.GUID guidService, [In] ref stdole.GUID riid, [Out, MarshalAs(UnmanagedType.IUnknown)] out object ppvObject);
  }
